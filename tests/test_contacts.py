...
class TestCaseContacts(unittest.TestCase):
    ...
    def test_23_language(self) -> None:
        """
    ...
    def test_24_get_fields(self) -> None:
        """
    ...
    def test_25_get_fields_attributes(self) -> None:
        """
        Get the model fields
        """
