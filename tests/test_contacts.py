...
class TestCaseContacts(unittest.TestCase):
    ...
    def test_21_language(self) -> None:
        """
    ...
    def test_22_get_fields(self) -> None:
        """
    ...
    def test_23_get_fields_attributes(self) -> None:
        """
        Get the model fields
        """
