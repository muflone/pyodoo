...
class TestCaseContacts(unittest.TestCase):
    ...
    def test_22_language(self) -> None:
        """
    ...
    def test_23_get_fields(self) -> None:
        """
    ...
    def test_24_get_fields_attributes(self) -> None:
        """
        Get the model fields
        """
